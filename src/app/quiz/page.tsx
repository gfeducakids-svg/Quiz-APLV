...
export default function QuizPage() {
  ...
  const getTheme = (questionIndex: number, optionIndex?: number) => {
    ...
    // Se a pergunta tem cores por opção e um optionIndex é fornecido
    if (theme && 'options' in theme && optionIndex !== undefined) {
      return (theme as { options: any[] }).options[optionIndex];
    }
    // Retorna o tema da pergunta ou um tema padrão/vazio se não encontrado
  ...
  const currentTheme = getTheme(currentQuestionIndex);
